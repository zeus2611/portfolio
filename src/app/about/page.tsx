          ...
          {about.certificates.display && (
            <>
              ...
              <Column fillWidth gap="m" marginBottom="40">
                {about.certificates.certificates.map((institution, index) => (
                  <Column
                    key={`${institution.name}-${index}`}
                    fillWidth
                    gap="4"
              ...
              <Column fillWidth gap="l">
                {about.technical.skills.map((skill, index) => (
                  <Column key={`${skill}-${index}`} fillWidth gap="4">
                    ...
                    <Flex fillWidth paddingTop="m" gap="16" wrap>
                      {skill.stack.map((tech, i) => (
                        ...
                        >
                          <Flex
                            ...
                            vertical="center"
                            horizontal="center"
                            className="text-neutral-strong" // Ensures icon matches theme text color
                          >
                            {tech.icon}
                          </Flex>
                          <Text
